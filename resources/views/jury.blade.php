                                ...
                                <div class="portlet-body form">
                                    <form role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label>NIK</label>
                                                <input class="form-control spinner" type="text" placeholder="Input Your NIK" name="nik"/>
                                            </div>
                                            <div class="form-group">
                                                <label>Loker</label>
                                                <input class="form-control spinner" type="text" placeholder="Input Your Loker" name="loker"/>
                                            </div>
                                        </div>
