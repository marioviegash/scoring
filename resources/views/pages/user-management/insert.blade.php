        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    @if($role == "ama")
                    <h1 class="page-title"> Create Admin Amoeba
                    </h1>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="portlet light bordered">
                                    ...
                                    <form role="form" action="{{url('admin/ama/add')}}" method="post" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                            <div class="form-body">
                    ...
                    @else 
                        <h1 class="page-title"> Create Jury
                        </h1>
                            ...
                            <div class="col-md-12">
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            <i class="icon-user font-red-sunglo"></i>
                                            <span class="caption-subject bold uppercase"> Field Jury Data</span>
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">
                                            </div>
                                    ...
                                    <div class="portlet-body form">
                                    <form role="form" action="{{url('admin/jury/add')}}" method="post" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <label>Name</label>
